...
<header class="top"><strong>📚 Quản trị Nhà Sách</strong><nav><a href="<?= URL_GOC ?>/admin/index.php">Tổng quan</a><a href="<?= URL_GOC ?>/admin/sach.php">Sách</a><a href="<?= URL_GOC ?>/admin/the-loai.php">Thể loại</a><a href="<?= URL_GOC ?>/admin/don-hang.php">Đơn hàng</a><a href="<?= URL_GOC ?>/admin/nguoi-dung.php">Người dùng</a><a href="<?= URL_GOC ?>/index.php" target="_blank">Xem web</a><a href="<?= URL_GOC ?>/dang-xuat.php">Đăng xuất</a></nav></header><main class="page">
<?php }
